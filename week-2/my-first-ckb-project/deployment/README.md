...
offckb deploy --network devnet --target <contract-binary-path> --output /home/digitaldrreamer/Documents/Projects/ckbuilders/week-2/my-first-ckb-project/deployment
```
...
```bash
# Deploy to testnet
offckb deploy --network testnet --target <contract-binary-path> --output /home/digitaldrreamer/Documents/Projects/ckbuilders/week-2/my-first-ckb-project/deployment
```
